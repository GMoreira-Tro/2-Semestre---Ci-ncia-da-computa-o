...
public class SinglyLinkedList<E> implements MyLinkedList<E> {
	Node<E> head;
	Node<E> tail;
	int numElements;
	...
	public SinglyLinkedList divideBy(E e) throws UnderflowException {
		return divideBy(e, new SinglyLinkedList<E>());
	}
	private SinglyLinkedList divideBy(E e, SinglyLinkedList l) throws UnderflowException {
		if (isEmpty())
			return l;
		E element = get(0);
		l.insertLast(removeFirst());
		if (element.equals(e)) {
			return l;
		}
		else 
